                  ...
                  <div
                    ...
                    className={`cursor-pointer rounded-lg border p-3 transition-colors sm:p-4 ${
                      selectedCaseId === caseItem.id
                        ? "border-green-300 bg-primary/10"
                        : ""
                    }`}
                  >
                    <div className="mb-1 break-words font-semibold text-base sm:text-lg">
                      {caseItem.case_name}
                    </div>
              ...
              <Card className="flex h-full flex-col">
                ...
                <CardContent className="h-full space-y-3 overflow-y-auto px-4 sm:space-y-4 sm:px-6">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                    <div>
                      <div className="mb-1 text-muted-foreground text-xs sm:text-sm">
                        Court
                      </div>
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-lg text-primary sm:text-xl">
